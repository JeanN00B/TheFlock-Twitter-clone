...
/**
 * Thin inbound adapter: Dialog-only composer over the real cursor feed with
 * delete-own. The global composer Dialog (shell New-post) owns the single
 * post path; its successes arrive here as a posted-token bump and reload
 * the current feed (the spec invalidation path).
 */
