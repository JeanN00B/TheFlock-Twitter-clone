...
import app.tweets.infrastructure.tweet_like_model  # noqa: F401  # register likes metadata
...
# Keep the URL in one place so Alembic and the application use the same settings.
